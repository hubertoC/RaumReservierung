 ...
 */
class Image extends \HZ\raumReservierungBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Image' . "\0" . 'tempFilename'];
        }
