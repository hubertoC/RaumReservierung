 ...
 */
class Student extends \HZ\raumReservierungBundle\Entity\Student implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Student' . "\0" . 'id', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Student' . "\0" . 'name', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Student' . "\0" . 'vorname', '' . "\0" . 'HZ\\raumReservierungBundle\\Entity\\Student' . "\0" . 'email', 'reservierung'];
        }
